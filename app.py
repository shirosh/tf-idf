...
law_book_text = read_docx('book.docx')
...
law_book_text_processed = preprocess_text(law_book_text)
...
law_book_tfidf = tfidf_vectorizer.fit_transform([law_book_text_processed])
...
similarity_scores = cosine_similarity(law_book_tfidf, taxonomy_tfidf)
